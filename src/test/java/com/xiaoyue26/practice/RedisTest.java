...
import com.xiaoyue.nov.practice.redis.Product;
...
public class RedisTest {
    ...
    @Autowired
    protected RedisTemplate<String, Product> redis;
    ...
    public void workingWithSimpleValues() {
        ...
        redis.opsForValue().set(product.getSku(), product);// 存

        Product found = redis.opsForValue().get(product.getSku());//取
